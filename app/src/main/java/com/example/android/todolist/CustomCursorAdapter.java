...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    public interface ListItemClickListener {
        void onListItemClick(int clickedItemIndex, String taskName, int taskPriority);
    }
    ...
    public CustomCursorAdapter(ListItemClickListener clickListener, Context context) {
    ...
    */
    ...
    class TaskViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            mlistItemClickListener.onListItemClick(clickedPosition, taskDescriptionView.getText().toString(),
